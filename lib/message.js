...
var bsonEndianConvertb2l = require('./bson').bsonEndianConvertb2l;
...
Message.prototype.parseHeader = function (xbuff) {
  ...
  this.RequestID = xbuff.readLong(20); // 8 bytes
};
...
Message.prototype.parseBody = function (xbuff) {
  this.ContextIDList = [xbuff.readLong(0)]; // 8 bytes
...
Message.prototype.parseLobBody = function (xbuff) {
  ...
  if (this.Flags === 0) {
    ...
    this.LobOffset = xbuff.readLong(28); // 8 bytes
