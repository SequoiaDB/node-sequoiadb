...
var bsonEndianConvert = function (doc, offset, length) {
  ...
  while (offset < doc.length) {
    ...
    case BSON.CODE_W_SCOPE: {
      ...
      offset += len + 4;
      len = doc.readInt32LE(offset);
      bsonEndianConvert(doc, offset, len - 1);
      offset += len;
      break;
    }
...
var bsonEndianConvertb2l = function (doc, offset, length) {
  offset = offset || 0;
  var start = offset;
  length = length || doc.length;
  // revert the doc length, it's an int(4 bytes)
  ...
  while (offset < doc.length) {
    ...
    case BSON.ARRAY: {
      len = doc.readInt32BE(offset);
      bsonEndianConvertb2l(doc, offset, len);
      offset += len;
      break;
    }
    case BSON.BINARY: {
    ...
    case BSON.CODE_W_SCOPE: {
      ...
      offset += len + 4;
      len = doc.readInt32BE(offset);
      bsonEndianConvertb2l(doc, offset, len - 1);
      offset += len;
      break;
    }
    case BSON.NUMBER_INT:
...
module.exports.bsonEndianConvertb2l = bsonEndianConvertb2l;
