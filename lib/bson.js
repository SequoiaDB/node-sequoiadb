...
// Get string length in BSON buffer
...
// Convert little-endian BSON buffer to big-endian
// Just reverse the number in BSON buffer
...
// Convert big-endian BSON buffer to little-endian
// Just reverse the number in BSON buffer
...
/**
 * Serialize Document to BSON buffer. If the target buffer must be is
 * big-endian, convert to big-endian after serialized
 */
exports.serialize = function (doc, isBigEndian) {
  // the buff always be little-endian, becuase the spec defined.
...
/**
 * Deserialize BSON buffer to Document, If the buffer is big-endian, convert to
 * little-endian first
 */
