...
/**
 * FLG_QUERY_STRINGOUT 0x00000001
 * Normally, query return bson stream, when this flag is added,
 * query return binary data stream
 */
Query.FLG_QUERY_STRINGOUT = 0x00000001;

/**
 * FLG_INSERT_CONTONDUP 0x00000080
...
/**
 * FLG_QUERY_PARALLED 0x00000100
 * Enable paralled sub query
 */
Query.FLG_QUERY_PARALLED = 0x00000100;

/**
 * FLG_QUERY_WITH_RETURNDATA 0x00000200
 * Return data in query response
 */
Query.FLG_QUERY_WITH_RETURNDATA = 0x00000200;

/**
 * FLG_QUERY_EXPLAIN 0x00000400
 * Explain query
 */
