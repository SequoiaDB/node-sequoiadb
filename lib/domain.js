...
var Domain = function (client, name) {
...
Domain.prototype.alter = function (options, callback) {
  ...
  this.client.sendAdminCommand(command, matcher, null, null, null, callback);
};
...
Domain.prototype.getList = function (type, callback) {
  ...
  this.client.getList(type, matcher, selector, null, callback);
};
