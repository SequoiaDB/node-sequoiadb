...
var getErrorMessage = function (code) {
  return exports.descriptions[Math.abs(code) - 1];
};
exports.getErrorMessage = getErrorMessage;

var SDBError = function (key, caller) {
  Error.captureStackTrace(this, caller || SDBError);
  var index = exports.errors[key];
  this.message = getErrorMessage(index);
  this.name = "SDBError";
};

util.inherits(SDBError, Error);

exports.SDBError = SDBError;
