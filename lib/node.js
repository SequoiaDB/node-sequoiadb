...
Node.prototype.getStatus = function (callback) {
  ...
  this.group.conn.sendAdminCommand(command, matcher, {}, {}, {}, function (err, response) {
    if (!err) {
...
Node.prototype.connect = function (username, password) {
  ...
  return new Connection(this.port, this.hostname, {
    user: username,
    pass: password
  });
};
...
Node.prototype.stopStart = function (start, callback) {
  ...
  this.group.conn.sendAdminCommand(command, matcher, {}, {}, {}, function (err) {
    callback(null, !err);
  });
};
