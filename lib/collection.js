...
Collection.prototype.splitAsync = function (source, dest, splitCondition, splitEndCondition, callback) {
  ...
  var command = constants.ADMIN_PROMPT + constants.SPLIT_CMD;
  var that = this;
  this.conn.sendAdminCommand2(command, matcher, {}, {}, {}, Long.ZERO, Long.NEG_ONE, 0, function (err, response) {
    if (err) {
      return callback(err);
    }
...
Collection.prototype.count = function (matcher, callback) {
  ...
  var that = this;
  this.conn.sendAdminCommand2(command, matcher, {}, {}, hint, Long.ZERO, Long.NEG_ONE, 0, function (err, response) {
    if (err) {
      return callback(err);
    }
...
Collection.prototype.attachCollection = function (subClFullName, options, callback) {
  ...
  this.conn.sendAdminCommand2(command, matcher, {}, {}, {}, Long.ZERO, Long.NEG_ONE, 0, callbackWrap(callback));
};
...
Collection.prototype.getLobs = function (callback) {
  ...
  matcher[constants.FIELD_COLLECTION] = this.collectionFullName;
  // run command
  this.conn.sendAdminCommand2(command, matcher, {}, {}, {}, Long.ZERO, Long.NEG_ONE, 0, callbackWrapForCursor(this, callback));
};
