...
Connection.getNextRequstID = function () {
  return Long.fromNumber(requestId++);
};
...
Connection.prototype.sendAdminCommand = function (command, matcher, selector, orderBy, hint, callback) {
  ...
  message.RequestID = Connection.getNextRequstID(); // 0
...
// snapshot type
mapping[constants.SDB_SNAP_CONTEXTS] = constants.CONTEXTS;
mapping[constants.SDB_SNAP_CONTEXTS_CURRENT] = constants.CONTEXTS_CUR;
mapping[constants.SDB_SNAP_SESSIONS] = constants.SESSIONS;
mapping[constants.SDB_SNAP_SESSIONS_CURRENT] = constants.SESSIONS_CUR;
mapping[constants.SDB_SNAP_COLLECTIONS] = constants.COLLECTIONS;
mapping[constants.SDB_SNAP_COLLECTIONSPACES] = constants.COLSPACES;
mapping[constants.SDB_SNAP_DATABASE] = constants.DATABASE;
mapping[constants.SDB_SNAP_SYSTEM] = constants.SYSTEM;
mapping[constants.SDB_SNAP_CATALOG] = constants.CATA;
